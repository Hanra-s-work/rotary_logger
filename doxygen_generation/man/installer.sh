...
# LAST Modified: 4:11:34 01-11-2025
# DESCRIPTION: 
# A module that provides a universal python light on iops way of logging to files your program execution.
# /STOP
# COPYRIGHT: (c) Asperguide
# PURPOSE: This is the bash script in charge of creating/installing the man page to your system.
# // AR
# +==== END rotary_logger =================+
# 
...
function create_homepage_man {
    ...
    local HOMEPAGE="${M_COMMENT} Manpage for Rotary Logger project
${M_COMMENT} Contact: Henry Letellier ${EMAIL}.
.TH ROTARY LOGGER ${SC_QUOTE}Asperguide${SC_QUOTE} 6 ${SC_QUOTE}September 2025${SC_QUOTE} ${SC_QUOTE}Version 1.0${SC_QUOTE} ${SC_QUOTE}Rotary Logger Manual${SC_QUOTE}
.PP
.SH NAME
Rotary${SC_SPACE}Logger ${SC_BACKSLASH}-${SC_SPACE}Welcome${SC_SPACE}to${SC_SPACE}Rotary${SC_SPACE}Logger!
.PP
.SH SYNOPSIS
.nf
.BI Rotary${SC_SPACE}Logger${SC_SPACE}${SC_TAB}${SC_TAB}${SC_SPACE}${SC_SPACE}${SC_SPACE}${SC_SPACE}-${SC_SPACE}${MSI_RESET}${SC_SPACE}https://hanra-s-work\\&.github\\&.io/rotary_logger/
.BI Rotary${SC_SPACE}Logger${SC_SPACE}documentation${SC_SPACE}-${SC_SPACE}${MSI_RESET}${SC_SPACE}https://hanra-s-work\\&.github\\&.io/rotary_logger/
.fi
.SH DESCRIPTION
.nf
.BI ${MSI_RESET}The${SC_SPACE}Rotary${SC_SPACE}Logger${SC_SPACE}project${SC_SPACE}is${SC_SPACE}a${SC_SPACE}python${SC_SPACE}module${SC_SPACE}that${SC_SPACE}aims${SC_SPACE}to${SC_SPACE}help${SC_SPACE}you${SC_SPACE}log${SC_SPACE}program${SC_SPACE}outputs${SC_SPACE}to${SC_SPACE}the${SC_SPACE}terminal${SC_SPACE}as${SC_SPACE}well${SC_SPACE}as${SC_SPACE}to${SC_SPACE}files${SC_SPACE}that${SC_SPACE}will${SC_SPACE}be${SC_SPACE}of${SC_SPACE}not${SC_SPACE}more${SC_SPACE}than${SC_SPACE}a${SC_SPACE}size${SC_SPACE}defined${SC_SPACE}in${SC_SPACE}the${SC_SPACE}module.
.BI ${MSI_RESET}
...
.nf
.BI ${MSI_RESET}Website:${SC_SPACE}https://hanra-s-work\\&.github\\&.io/rotary_logger/
.BI ${MSI_RESET}Source${SC_SPACE}code${SC_SPACE}(Github):${SC_SPACE}https://github\\&.com/Hanra-s-work/rotary_logger
.BI ${MSI_RESET}Documentation:${SC_SPACE}https://hanra-s-work\\&.github\\&.io/rotary_logger/
.fi
.PP
.SH DISCLAIMER
.PP
...
function update_man_paths {
    MAN_DEST="$1"
    # Update the shell man paths to include the Rotary Logger folder
    echo "Updating the shell man paths to include the Rotary Logger folder"
    ...
    echo "Updated the shell man paths to include the Rotary Logger folder"
}
...
function update_man_db {
    ...
    if grep -qF "$MY_MAN_PATH" "$DESTINATION"; then
        echo "The man paths for Rotary Logger are correct"
        return
    fi
    echo "#" >>"$DESTINATION"
    echo "#---------------------------------------------------------" >>"$DESTINATION"
...
decho "Removed '$MAN_DEST' and '$MAN_DIR/Rotary Logger.3' if they existed"
...
add_required_mans "$MAN_SHORTCUT_HOME" "$MAN_DEST" "Rotary Logger.6"
...
echo "Installation complete. You can now use 'man Rotary Logger' to access the manual page."
