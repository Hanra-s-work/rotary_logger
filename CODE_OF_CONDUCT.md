...
-- LAST Modified: 4:15:16 01-11-2025
-- DESCRIPTION: 
-- A module that provides a universal python light on iops way of logging to files your program execution.
-- /STOP
-- COPYRIGHT: (c) Asperguide
-- PURPOSE: This is the document explaining how to behave in this repository.
-- // AR
-- +==== END rotary_logger =================+
-->
# Rotary Logger Repository Code of Conduct
...
We are committed to making participation in the Rotary Logger repository a positive experience for all contributors. By participating in this project, you agree to abide by the following standards of behavior.
...
The maintainers of the Rotary Logger repository reserve the right to take appropriate action if any part of this Code of Conduct is violated. This may include:
...
Thank you for helping make the Rotary Logger repository a positive and inclusive environment for all!
